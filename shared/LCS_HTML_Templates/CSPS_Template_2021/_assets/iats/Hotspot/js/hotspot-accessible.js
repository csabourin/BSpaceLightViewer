...
HotSpotApp.buildApp = function () {
    ...
    if (HotSpotApp.AppData.PreActivityText === 'none' || HotSpotApp.AppData.PreActivityText === null || HotSpotApp.AppData.PreActivityText === undefined || HotSpotApp.AppData.PreActivityText === '') {
        if (
...
HotSpotApp.buildSceneContent = function (scene, content, location) {
    ...
    if (
        HotSpotApp.Scenes[scene].HotSpotContent[content].popUpName !== 'none' &&
...
HotSpotApp.Eval = function (num, scene, content, location, correctAnswer) {
    ...
    if (idNum !== null) {
        ...
        if (HotSpotApp.Scenes[scene].HotSpotContent[content].feedback === true) {
            if (
                HotSpotApp.Scenes[scene].HotSpotContent[content].answers[idNum].feedback !== 'none' &&
                ...
                HS_feedback.innerHTML =
                    '<strong>You Chose: ' +
                    HotSpotApp.Scenes[scene].HotSpotContent[content].answers[idNum].answerText +
                    '</strong></br><strong>Correct Answer: ' +
                    HotSpotApp.Scenes[scene].HotSpotContent[content].answers[correctAnswer].answerText +
                    '</strong></br><strong>Feedback: ' +
                    HotSpotApp.Scenes[scene].HotSpotContent[content].answers[idNum].feedback +
                    '</strong>';
